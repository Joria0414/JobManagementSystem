...
<html>
	...
	<body>
		...
		<table width="100%" height="90%" border="0" cellpadding="10" cellspacing="0" class="main_tabbor">
		  	<tr valign="top">
			    <td>
			     <form id="form01" action="${pageContext.request.contextPath}/UpdateNoticeSvl" method="post">
				  <!-- 隐藏表单，flag表示添加标记 -->
    	 			<input type="hidden" name="flag" value="2">
    	 			<input type="hidden" name="noticeid" value="${notice.noticeid}">
				  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
					    <tr><td class="font3 fftd">
					                公告标题：<input type="text" name="noticename" size="30" id="title" value="${notice.noticename}"/>
						...
						<tr><td class="font3 fftd">公告内容：<br/>
							<textarea name="noticecontent" cols="88" rows="11" id="content" >${notice.noticecontent}</textarea>
						</td></tr>
						<tr><td class="main_tdbor"></td></tr>
