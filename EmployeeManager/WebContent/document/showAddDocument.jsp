		...
		<table width="100%" height="90%" border="0" cellpadding="10" cellspacing="0" class="main_tabbor">
		  	<tr valign="top">
			    <td>
                        ...
                        <!-- 隐藏表单，flag表示添加标记 -->
                    <form action="${pageContext.request.contextPath}/AddDocSql" method="post" enctype="multipart/form-data" >
				    ...
				    <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
						...
						<tr><td class="main_tdbor"></td></tr>
					    <div style="height:10px;"><front style="color:red">${msg}</front></div>
