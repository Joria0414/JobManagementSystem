		...
		<tr valign="top">
			<td height="30">
				<table width="100%" border="0" cellpadding="0" cellspacing="10"
					...
					<tr>
						<td class="fftd">
							<form action="FindExactDeptSvl" method="post">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td class="font3">部门名称：<input type="text" id="search" name="name" value="${deptname}">
			...
			<td height="20">
				<table width="100%" border="1" cellpadding="5" cellspacing="0"
					...
					<tbody>
						...
						<c:forEach var="dep" items="${requestScope.pageinfo.lists}">
							<tr id="data_0" align="center" class="main_trbg"
								style="background-color: rgb(255, 255, 255);">
								<td><input type="checkbox" id="box_0" value="${dep.depid}"></td>
								<td>${dep.depname}</td>
								<td>${dep.dedetail}</td>

								<td align="center" width="40px;"><a
									href="dept/showUpdateDept.jsp?depid=${dep.depid}&depname=${dep.depname}&dedetail=${dep.dedetail}">
										<img title="修改"
							...
							<td
								...
								<c:if test="${pageinfo.currentPage ne 1}">
									<span class="disabled"> <a
										href="FindExactDeptSvl?current=${pageinfo.currentPage-1}&name=${deptname}">上一页</a></span>
								</c:if> <%-- <span class="current">${pageinfo.currentPage}</span> --%>

								<c:if test="${pageinfo.currentPage!=pageinfo.totalPage}">
									<a href="FindExactDeptSvl?current=${pageinfo.currentPage+1}&name=${deptname}">下一页</a>
								</c:if> &nbsp;跳转到&nbsp;&nbsp; <input
