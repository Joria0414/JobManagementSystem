...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tbody><tr valign="top">
    <td>
    	    <form id="form02" action="${pageContext.request.contextPath}/AddEmpSvl" method="post">
		 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
			...
			<tr>
				<td class="font3 fftd">
					密&nbsp;&nbsp;&nbsp;&nbsp;码：<input name="password" id="password" size="40">
				
					 &nbsp;&nbsp;身份：
									<select name="role" style="width:143px;">
			...
			<input type="submit"  value="添加">&nbsp;&nbsp;<input type="reset" value="清空 "></td></tr>
		  </tbody></table>
		 </form>
	</td>
  </tr>
