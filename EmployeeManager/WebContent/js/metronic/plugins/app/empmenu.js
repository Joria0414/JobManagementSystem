...
function loadMenu(){
	...
	var json='[{"id": "1","name": "CSI员工之家","icon": null,"url": "","parentId": "",'
		...
		+'"childs": [{"id": "12","name": "部门","icon": "/xingxing.png","url": "dept/dept.html","parentId": "1",'
		+'"childs": [{"id": "121","name": "部门查询","icon": "","url": "FindAllDeptSvl","parentId": "12",'
	
		+'"childs": []}]},{"id": "14","name": "职位","icon": "/xingxing.png","url": "job/job.html","parentId": "1",'
		+'"childs": [{"id": "141","name": "职位查询","icon": "","url": "FindAllJobtSvl","parentId": "14",'
	
		+'"childs": []}]},{"id": "15","name": "员工","icon": "/xingxing.png","url": "employee/employee.html","parentId": "1",'
		+'"childs": [{"id": "151","name": "员工查询","icon": "","url": "FindAllEmpstaffSvl","parentId": "15",'
		+'"childs": []},{"id": "152","name": "修改我的信息","icon": "","url": "FindEmpDetailmeSvl","parentId": "15",'
	
		+'"childs": []}]},{"id": "16","name": "公告","icon": "/xingxing.png","url": "notice/notice.html","parentId": "1",'
		...
		+'"childs": [{"id": "181","name": "查看我发布的日报","icon": "","url": "FindAllReportmeSvl?type=1","parentId": "18",'
		+'"childs": []},{"id": "182","name": "添加日报","icon": "","url": "dreport/showAddDReport.jsp","parentId": "18",'
		
		+'"childs": []}]},{"id": "19","name": "工作月报管理","icon": "/xingxing.png","url": "document/document.html","parentId": "1",'
		+'"childs": [{"id": "191","name": "查看我发布的月报","icon": "","url": "FindAllReportmeSvl?type=2","parentId": "19",'
		+'"childs": []},{"id": "192","name": "添加月报","icon": "","url": "mreport/showAddMReport.jsp","parentId": "19",'
		
		+'"childs": []}]},{"id": "20","name": "请假申请管理","icon": "/xingxing.png","url": "document/document.html","parentId": "1",'
		+'"childs": [{"id": "201","name": "查看我的请假申请","icon": "","url": "FindAllLeavemeSvl?type=1","parentId": "20",'
		+'"childs": []},{"id": "202","name": "请假申请","icon": "","url": "apply/showAddApplyq.jsp","parentId": "20",'
		
		+'"childs": []}]},{"id": "21","name": "外出申请管理","icon": "/xingxing.png","url": "notice/notice.html","parentId": "1",'
		+'"childs": [{"id": "211","name": "查看我的外出情况","icon": "","url": "FindAllLeavemeSvl?type=2","parentId": "21",'
		+'"childs": []},{"id": "212","name": "外出申请","icon": "","url": "apply/showAddApplyw.jsp","parentId": "21","childs": []}]}]}]';
		
		/*+'"childs": []}]},{"id": "22","name": "加班申请管理","icon": "/xingxing.png","url": "notice/notice.html","parentId": "1",'
		+'"childs": [{"id": "221","name": "加班查询","icon": "","url": "FindAllWorkSvl","parentId": "22",'
		+'"childs": []},{"id": "222","name": "查看员工考勤","icon": "","url": "notice/showAddNotice.html","parentId": "23","childs": []}]}]}]';*/
		...
		+'"childs": []},{"id": "232","name": "查看员工考勤","icon": "","url": "notice/showAddNotice.html","parentId": "23","childs": []}]}]}]';*/
...
function firstMenuClick() {
	var a = findFirstMenu($("#leftMenuNav2"));
	if (a.length>0) {
		a[0].click();
	}
}
