...
function loadMenu(){
	...
	+'"childs": [{"id": "141","name": "职位查询","icon": "","url": "FindAllJobtSvl","parentId": "14",'
	...
	+'"childs": []},{"id": "152","name": "添加员工","icon": "","url": "ShowAddEmpSvl","parentId": "15",'
	...
	+'"childs": [{"id": "171","name": "文档查询","icon": "","url": "FindAllDocsvl","parentId": "17",'
	+'"childs": []},{"id": "172","name": "上传文档","icon": "","url": "document/showAddDocument.jsp","parentId": "17",'
	
	/*+'"childs": []}]},{"id": "18","name": "工作日报管理","icon": "/xingxing.png","url": "document/document.html","parentId": "1",'
	+'"childs": [{"id": "181","name": "查看日报","icon": "","url": "FindAllDReportSvl","parentId": "18",'
	+'"childs": []},{"id": "182","name": "发布修改日报","icon": "","url": "document/showAddDocument.jsp","parentId": "18",'	
	+'"childs": []}]},{"id": "19","name": "工作月报管理","icon": "/xingxing.png","url": "document/document.html","parentId": "1",'
	+'"childs": [{"id": "191","name": "查看月报","icon": "","url": "FindAllMReportSvl","parentId": "19",'
	+'"childs": []},{"id": "192","name": "发布修改月报","icon": "","url": "document/showAddDocument.jsp","parentId": "19",'*/
	
	+'"childs": []}]},{"id": "18","name": "工作日报管理","icon": "/xingxing.png","url": "FindAllDReportSvl","parentId": "1",'
	
	
	+'"childs": [{"id": "181","name": "查看日报","icon": "","url": "FindAllDReportSvl","parentId": "18",'
	
	/*+'"childs": []},{"id": "182","name": "总体日报发布情况","icon": "","url": "dreport/showUpdateDReport.jsp","parentId": "18",'*/
	
	/*+'"childs": []},{"id": "182","name": "发布修改日报","icon": "","url": "dreport/showUpdateDReport.jsp","parentId": "18",'	*/
	...
	+'"childs": []}]},{"id": "20","name": "请假申请管理","icon": "/xingxing.png","url": "document/document.html","parentId": "1",'
	+'"childs": [{"id": "201","name": "请假审批","icon": "","url": "FindAllAbsentSvl?applytype=1","parentId": "20",'
	/*+'"childs": []},{"id": "202","name": "请假审批","icon": "","url": "document/showAddDocument.html","parentId": "20",'*/
	+'"childs": []}]},{"id": "21","name": "外出申请管理","icon": "/xingxing.png","url": "notice/notice.html","parentId": "1",'
	+'"childs": [{"id": "211","name": "外出审批","icon": "","url": "FindAllAbsentSvl?applytype=2","parentId": "21","childs": []}]}]}]';
	/*+'"childs": []},{"id": "212","name": "外出审批","icon": "","url": "notice/showAddNotice.html","parentId": "21",'*/
	/*+'"childs": []}]},{"id": "22","name": "加班申请管理","icon": "/xingxing.png","url": "notice/notice.html","parentId": "1",'
	+'"childs": [{"id": "221","name": "加班查询","icon": "","url": "notice/notice.html","parentId": "22",'*/
	/*+'"childs": []},{"id": "222","name": "加班审批","icon": "","url": "notice/showAddNotice.html","parentId": "22",'*/
	/*+'"childs": []}]},{"id": "23","name": "考勤管理","icon": "/xingxing.png","url": "notice/notice.html","parentId": "1",'
	+'"childs": [{"id": "231","name": "上传考勤文档","icon": "","url": "notice/notice.html","parentId": "23",'
	+'"childs": []},{"id": "232","name": "查看员工考勤","icon": "","url": "notice/showAddNotice.html","parentId": "23",'
	+'"childs": []}]},{"id": "24","name": "会议室预约","icon": "/xingxing.png","url": "notice/notice.html","parentId": "1",'
	+'"childs": [{"id": "241","name": "查看会议室预约情况","icon": "","url": "notice/notice.html","parentId": "24",'
	+'"childs": []},{"id": "243","name": "会议室预约申请","icon": "","url": "notice/notice.html","parentId": "24",'""childs": []}]}]}]';
	+'"childs": []},{"id": "242","name": "会议室预约申请","icon": "","url": "notice/showAddNotice.html","parentId": "24","childs": []}]}]}]';
	*/
