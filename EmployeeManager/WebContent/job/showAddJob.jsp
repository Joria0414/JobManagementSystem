	...
	<script type="text/javascript">
		...
		function submit() {
			...
			$.ajax({
				...
				url : "../AddJobSvl",//发送到什么位置
				data : {
					"jobname" : name.val(),
					"jobdetail" : remark.val()
    ...
    <td>
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">职位名称：<input type="text" name="name" id="name" size="20" onblur="checkJobName()"/></td>
