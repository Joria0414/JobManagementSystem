...
/**
 * Servlet implementation class FindAllMReportSvl
 */
public class FindAllMReportSvl extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FindAllMReportSvl() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		biz.findAllReport(pageInfo,reportname, reportcontent, reportempname,reporttime,"2");
		// 2.将列表保存到请求域
		request.setAttribute("pageinfo", pageInfo);
		// 3.请求转发
		request.getRequestDispatcher("mreport/mreport.jsp").forward(request, response);
	}
