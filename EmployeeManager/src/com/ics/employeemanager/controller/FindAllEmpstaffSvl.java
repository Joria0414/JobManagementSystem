...
/**
 * Servlet implementation class FindAllEmpstaffSvl
 */
public class FindAllEmpstaffSvl extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FindAllEmpstaffSvl() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 5.请求转发employee.jsp
		request.getRequestDispatcher("employee/employee2.jsp").forward(request, response);
	}
